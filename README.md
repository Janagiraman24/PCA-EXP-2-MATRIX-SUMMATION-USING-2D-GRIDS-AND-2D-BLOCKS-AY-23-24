...
## OUTPUT:
<img width="1046" height="191" alt="image" src="https://github.com/user-attachments/assets/6acd4448-506f-4e34-baa3-8e23d4bbcc41" />


## RESULT:
The host took 1.113626 seconds to complete its computation, while the GPU outperforms the host and completes the computation in 0.118875 seconds. Therefore, float variables in the GPU will result in the best possible result. Thus, matrix summation using 2D grids and 2D blocks has been performed successfully.
